#!/usr/bin/env node
/**
 * AMEVA Standard Node.js CLI Runner for termux_stt.
 * Automatically resolves Python 3 environment and dispatches to python -m termux_stt.
 */
const fs = require('fs');
...
child.on('error', (err) => {
  console.error(`[${'termux_stt'}] Failed to spawn python process (${pythonBin}):`, err.message);
  process.exit(1);
});
